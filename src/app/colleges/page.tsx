...
const TIERS = [
  { label: "Safety",            color: "bg-tier-safety-fg",       textColor: "text-tier-safety-fg",       chance: "70%+",   description: "Estimated chance of admission is 70% or higher. Your profile lines up well with the school's typical admit." },
  { label: "Likely",            color: "bg-tier-likely-fg",       textColor: "text-tier-likely-fg",       chance: "40–69%", description: "Estimated chance is 40–69%. A strong match but not guaranteed. Schools under 15% acceptance cannot classify here regardless of profile — top schools have institutional uncertainty (hooked-applicant slots, class composition needs) that prevents unhooked applicants from being 'likely'." },
  { label: "Target",            color: "bg-tier-target-fg",       textColor: "text-tier-target-fg",       chance: "20–39%", description: "Estimated chance is 20–39%. Realistic but competitive. Final outcomes depend on essays, recommendations, and demonstrated interest in addition to stats." },
  { label: "Reach",             color: "bg-tier-reach-fg",        textColor: "text-tier-reach-fg",        chance: "5–19%",  description: "Estimated chance is 5–19%. Admission is possible with a strong qualitative profile. Schools with under 10% acceptance always cap here, even with elite stats — outcomes are not predictable at that selectivity." },
  { label: "Unlikely",          color: "bg-tier-unlikely-fg",     textColor: "text-tier-unlikely-fg",     chance: "<5%",    description: "Estimated chance is below 5%. Would require exceptional circumstances. Elite-profile applicants (4.0 UW, 1540+ SAT or 35+ ACT, 6+ APs) never land here — the chance model floors at 'reach' for that profile." },
  { label: "Insufficient Data", color: "bg-tier-insufficient-fg", textColor: "text-text-secondary",       chance: "—",    description: "We don't have enough of your profile to ground a chance estimate. Add a GPA or test score to unlock per-school chances." },
];
