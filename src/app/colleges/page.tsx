...
export default function CollegesPage() {
  ...
  return (
    <AuroraBackground>
      <EditorialAtmosphere />
      <main className="editorial-luxury mx-auto max-w-5xl px-4 sm:px-6 py-16 sm:py-24 font-[family-name:var(--font-geist-sans)]">
        <AtlasHero
          eyebrow="Browse · Pin · Build"
          title="The atlas,"
          accent="charted."
          lede="Sortable by chance, acceptance rate, or major fit. Pin schools to assemble your list, then head to your graded list for the second-opinion read."
        />
