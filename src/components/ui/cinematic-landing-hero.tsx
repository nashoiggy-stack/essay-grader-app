...
const FEATURES = [
  {
    ...
    icon: PenLine,
    title: "Essay Grader",
    description: "Grade your Common App essay with 7 criteria + VSPICE rubric. Get inline suggestions and coaching chat.",
    stat: "7+V",
    statLabel: "Criteria",
  },
  {
    ...
    description: "Calculate weighted and unweighted GPA across high school and college scales. Auto-fills into other tools.",
    stat: "4",
    statLabel: "Scales",
  },
  {
    ...
    icon: ClipboardList,
    title: "EC Evaluator",
    description: "Describe your activities in conversation. Get tier ratings, profile analysis, and spike detection.",
    stat: "4",
    statLabel: "Tiers",
  },
  {
    ...
    icon: School,
    title: "College List",
    description: "Build a balanced list across 5 tiers — Safety, Likely, Target, Reach, Unlikely — filtered by your profile.",
    stat: "80+",
    statLabel: "Schools",
  },
  {
    ...
    description: "Estimate your admission chances at any school. Pulls your GPA, essay, and EC scores automatically.",
    stat: "5",
    statLabel: "Bands",
  },
];
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        // Phase 3: Feature cards appear one by one
              ...
              {FEATURES.map((feature) => {
                ...
                return (
                  <Link
                    key={feature.href}
                    href={feature.href}
                    className="feature-grid-item gsap-reveal feature-card-depth rounded-2xl p-5 transition-all duration-300 hover:-translate-y-1 hover:bg-white/[0.08] group"
                  >
